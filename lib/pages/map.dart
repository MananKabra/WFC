...
class _MyHomePageState extends State<MyHomePage> {
  ...
  PermissionStatus _permissionGranted = PermissionStatus.none;
  ...
  void initState() {
    super.initState();
    getLocation();
    locationSubscription = Location().onLocationChanged.listen((LocationData _locationData){
      setState(() {
  ...
  setMarker(){
    ...
    allMarker.add(Marker(
        ...
        height: 100.0,
        point:
        latLng.LatLng(_locationData?.latitude??0.0, _locationData?.longitude??0.0),
        builder: (ctx)=>Icon(
    ...
    return new Scaffold(
      ...
      body:   _locationData != null
          ...
          options: new MapOptions(
              center: new latLng.LatLng(_locationData?.latitude ?? 0.0, _locationData?.longitude ?? 0.0),
              zoom: 14.0),
          layers: [
